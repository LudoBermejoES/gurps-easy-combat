export default {
  ...
  KATANA: { texturePath: 'moulinette/images/custom/Ludo/Armas%20modernas/Katana.png', scale: '1', name: 'Katana' },
  'ALS POCKET': {
    texturePath: 'moulinette/images/custom/Ludo/Armas%20modernas/ALS_Pocket_smoke.png',
    scale: '1',
    name: 'ALS_Pocket_smoke',
  },
  'GLI-F4': { texturePath: 'moulinette/images/custom/Ludo/Armas%20modernas/GLI-F4.png', scale: '1', name: 'GLI-F4' },
  'SCHERMULY STUN': {
  ...
  SHURIKEN: { texturePath: 'icons/skills/ranged/shuriken-thrown-orange.webp', scale: '0.5', name: 'Shuriken' },
  RAPIER: {
    texturePath: 'moulinette/images/custom/Forgotten-Adventures/Combat/Weapons/Swords/Rapier_A_01_1x1.png',
    scale: '1',
    name: 'Rapier',
  },
  MACE: { texturePath: 'moulinette/images/custom/Forgotten-Adventures/Weapons/Mace_01.png', scale: '1', name: 'Mace' },
  KNIFE: {
